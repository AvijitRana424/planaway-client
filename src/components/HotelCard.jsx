  ...
  return (
    <div style={styles.card}>
      ...
      <div style={styles.right}>
        ...
        <p style={{ fontSize: 11, color: 'var(--muted)', marginBottom: 12 }}>avg per night</p>
...
const styles = {
  card: { background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', padding: '20px', display: 'flex', alignItems: 'center', gap: 20 },
  imgBox: { width: 80, height: 80, background: 'rgba(255,255,255,0.04)', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 36, flexShrink: 0 },
  info: { flex: 1 },
  ...
  name: { fontFamily: 'Playfair Display, serif', fontSize: 16, fontWeight: 600, color: 'var(--text)', marginBottom: 4 },
  location: { fontSize: 13, color: 'var(--muted)', marginBottom: 8 },
  ratingRow: { display: 'flex', alignItems: 'center', gap: 6 },
  stars: { color: 'var(--gold)', fontSize: 13, fontWeight: 500 },
  reviews: { fontSize: 12, color: 'var(--muted)' },
  right: { textAlign: 'right', flexShrink: 0 },
  price: { fontSize: 20, fontWeight: 600, fontFamily: 'Playfair Display, serif', color: 'var(--text)' },
};
